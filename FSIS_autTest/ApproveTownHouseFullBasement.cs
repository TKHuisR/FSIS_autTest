...
{
    public class ApproveTownHouseFullBasement
    {
        [Fact]
        ...
        public void LoadQuotePage()
        {
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div/input")).SendKeys("52960 JAYHAWK DR # 9, MCCONNELL AFB, KS 67221");
                //Input Address
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/ul/li[2]/button")).Click();
                ...
                driver.FindElement(By.ClassName("field-select2-option")).Click();
                DemoHelper.Pause();
               ...
               //Input Square Footage
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[1]/input")).SendKeys("ApprTownhouseFBase");
                //Input First Name
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[2]/input")).SendKeys("ApprTownhouseFBase");
                //Input Last Name
