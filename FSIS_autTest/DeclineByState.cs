    ...
    public class DeclineByState
    {
        ...
        public void LoadApplicationPage()
        {
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div/input")).SendKeys("1104 APOEPOE PL, PEARL CITY, HI 96782");
                //Input Address
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[1]/input")).SendKeys("DeclineByStateTest");
                //Input First Name
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[2]/input")).SendKeys("DeclineByStateTest");
                //Input Last Name
