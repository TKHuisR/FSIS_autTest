...
{
    public class DeclineByFloodLoss
    {
        [Fact]
        ...
        public void LoadApplicationPage()
        {
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div/input")).SendKeys("2630 S FEDERAL BLVD, DENVER, CO 80219");
                //Input Address
                ...
                driver.FindElement(By.XPath("/html/body/div[1]/div[2]/div/div/div/mat-option[1]/span")).Click();
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/input")).SendKeys("2700");
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[1]/input")).SendKeys("DeclineByFloodLoss");
                //Input First Name
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[2]/input")).SendKeys("DeclineByFloodLoss");
                //Input Last Name
