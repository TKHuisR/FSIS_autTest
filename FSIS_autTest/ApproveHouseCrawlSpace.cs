...
{
    public class ApproveHouseCrawlSpace
    {
        [Fact]
        ...
        public void LoadApplicationPage()
        {
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div/input")).SendKeys("100 E CENTRAL BLVD, ORLANDO, FL 32801");
                //Input Address
                ...
                driver.FindElement(By.XPath("/html/body/div[1]/div[2]/div/div/div/mat-option[2]")).Click();
                //Select "Residental - Renter Occupied"
                DemoHelper.Pause();

                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/ul/li[5]/button")).Click();
                //Select "Home with Crawl Space"
                DemoHelper.Pause();
                ...
                //Select "Crawlspace - Above Ground"
                DemoHelper.Pause();

                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/input")).SendKeys("1741");
                ...
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[1]/input")).SendKeys("HouseCrawlSpaceAboveG");
                //Input First Name
                driver.FindElement(By.XPath("/html/body/app-root/div/section/app-quote/div[1]/div/div/div[1]/div[2]/input")).SendKeys("HouseCrawlSpaceAboveG");
                //Input Last Name
